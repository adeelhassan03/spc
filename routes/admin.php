...
use App\Http\Controllers\Backend\CatalogMessagesController;
use App\Http\Controllers\Backend\FaqMessagesController;
...
/**
 * Catalog Order  Routes
 */
Route::group(['prefix' => ''], function () {
    Route::resource('catalogMessages', CatalogMessagesController::class);
});
Route::get('catalogMessages/{order}', 'CatalogMessagesController@show')->name('admin.catalogMessages.show');

/**
 * Faq Messages Routes
 */
Route::group(['prefix' => ''], function () {
    Route::resource('faqMessages', FaqMessagesController::class);
});
Route::get('faqMessages/{order}', 'FaqMessagesController@show')->name('admin.faqMessages.show');
