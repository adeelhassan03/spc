<section class="section section-with-shape-divider section-parallax bg-tertiary border-0 m-0" data-plugin-parallax="" data-plugin-options="{&#39;speed&#39;: 1.5, &#39;parallaxHeight&#39;: &#39;110%&#39;, &#39;fadeIn&#39;: true}" data-image-src="'{{ asset('public/modules/spc/images/common/background-4.jpg') }}'" style="position: relative; overflow: hidden;">
    <div class="parallax-background fadeIn animated" style="background-image: url('{{ asset('public/modules/spc/images/common/background-1.jpg') }}'); background-size: cover; position: absolute; top: 0px; left: 0px; width: 100%; height: 110%; transform: translate3d(0px, 1699.71px, 0px); background-position-x: 50%;">
    </div>
