    ...
    <div class="container mt-2 mb-5 pb-5">
        <div class="row align-items-center mb-4">
            <div class="col-lg-5 mb-5 mb-lg-0">
                ...
                <a href="{{ route('spc.about') }}" class="btn btn-primary btn-modern font-weight-bold text-3 px-5 py-3 appear-animation animated fadeInUpShorter appear-animation-visible" data-appear-animation="fadeInUpShorter" data-appear-animation-delay="1800" style="animation-delay: 1800ms;">VIEW MORE</a>
            </div>
            <div class="col-sm-10 col-lg-6 offset-sm-1 ps-sm-5 ps-lg-0">
                <div class="position-relative">
                    <div data-plugin-float-element="" data-plugin-options="{&#39;startPos&#39;: &#39;top&#39;, &#39;speed&#39;: 0.2, &#39;transition&#39;: true, &#39;transitionDuration&#39;: 1000, &#39;isInsideSVG&#39;: true}" style="top: 0px; transition: transform 1000ms ease-out 0ms; transform: translate3d(0px, -8.42348%, 0px);">
                        <img src="{{ asset('public/modules/spc/images/common/generic-2.jpg') }}" class="img-fluid rounded-circle custom-box-shadow-1 appear-animation animated fadeInLeftShorter appear-animation-visible" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="1800" alt="" style="animation-delay: 1800ms;">
                    </div>
                    <div class="position-absolute top-50pct left-50pct transform3dxy-n50" style="left: 25%;">
                        <div data-plugin-float-element="" data-plugin-options="{&#39;startPos&#39;: &#39;top&#39;, &#39;speed&#39;: 0.3, &#39;transition&#39;: true, &#39;transitionDuration&#39;: 1000, &#39;isInsideSVG&#39;: true}" style="top: 0px; transition: transform 1000ms ease-out 0ms; transform: translate3d(0px, -4.47016%, 0px);">
                            <img src="{{ asset('public/modules/spc/images/common/service-hardware-1.jpg') }}" class="img-fluid rounded-circle custom-box-shadow-1 appear-animation animated fadeInLeftShorter appear-animation-visible" data-appear-animation="fadeInLeftShorter" data-appear-animation-delay="1400" alt="" style="animation-delay: 1400ms;height: 400px;">
                        </div>
                    </div>
                </div>
            </div>
