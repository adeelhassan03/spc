                ...
                <div class="form-body">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label" for="category_id">Article Category 
...
@section('scripts')
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        titleInput.addEventListener("input", function() {
            var title = titleInput.value.trim().toLowerCase(); // Get the title and convert to lowercase
            var slug = title.replace(/\s+/g, '-'); // Replace spaces with dashes
            slugInput.value = slug; // Set the value of slug input field
        });
    });
</script>
