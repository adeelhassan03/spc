            ...
            $datatable = DataTables::of($pages, $isTrashed)
                ...
                ->addColumn(
                    ...
                    function ($row) use ($isTrashed) {
                        ...
                        $categorySlug = $row->category->slug; // Ensure you have the category slug
                        $pageSlug = $row->slug; // The page slug
                        $html = '<a class="btn waves-effect waves-light btn-info btn-sm btn-circle" title="View Page Details" href="' . route('spc.page.show', [$categorySlug, $pageSlug]) . '" target="_blank"><i class="fa fa-eye"></i></a>';
