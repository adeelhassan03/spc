    ...
    public function update(Request $request)
    {
        ...
        try {
            ...
            if (!is_null($request->footer_logo)) {
                $this->general->footer_logo = UploadHelper::update('footer_logo', $request->footer_logo, 'footer_logo', 'public/assets/images/logo', $this->general->footer_logo);
            }
            ...
            $this->contact->location           = $request->location;
