                    ...
                    <div class="col-md-12">
                        <div class="d-flex no-block align-items-center pointer" onclick="location.href='{{ route('admin.admins.index') }}'">
                            <div>
                                ...
                                <p class="font-16 m-b-5 text-white">Total Admins</p>
                            </div>
                            <div class="ml-auto">
                                <h1 class="font-light text-right text-white">{{ $count_admins }}</h1>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="d-flex no-block align-items-center pointer" onclick="location.href='{{ route('admin.categories.index') }}'">
                        <div>
                            ...
                            <p class="font-16 m-b-5 text-white">Total Categories</p>
                        </div>
                        <div class="ml-auto">
                            <h1 class="font-light text-right text-white">{{ $count_categories }}</h1>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="d-flex no-block align-items-center pointer" onclick="location.href='{{ route('admin.pages.index') }}'">
                            <div>
                                <i class="mdi mdi-tune font-20 text-muted"></i>
                                <p class="font-16 m-b-5 text-white">Total Articles / Pages</p>
                            </div>
                            <div class="ml-auto">
                                <h1 class="font-light text-right text-white">{{ $count_pages }}</h1>
                            </div>
                        </div>
                    </div>
                </div>
