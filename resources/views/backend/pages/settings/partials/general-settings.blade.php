<div class="row">
    ...
    <div class="form-group">
            <label class="control-label" for="footer_logo">
                Footer Logo &nbsp;
                <i class="fa fa-info-circle" data-toggle="tooltip"
                    title="Only png jpg jpeg webp svg type
                images are allowed. Max image size 0.5 MB."></i>
            ...
            <input type="file" class="form-control dropify" data-allowed-file-extensions="png jpg jpeg webp svg"
       data-max-file-size="500K" data-height="100" id="footer_logo" name="footer_logo" 
       data-default-file="@if($settings->general->footer_logo){{ asset('public/assets/images/logo/' . $settings->general->footer_logo) }}@endif" />
        </div>
</div>
